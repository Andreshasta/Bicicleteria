 ...
 * @author Andres
 */
public class BusEjecutivo50 implements Kilometraje {
    ...
    public void categoriaTiquet(double kilometro) {
        if (kilometro < 100 && kilometro >= 10) {

           salario=SalarioMinimo.getInstancia();
            System.out.println("Su pasaje tiene un costo de "+(salario.getValor()/50)+" pesos, su viaje se realizará en Bus ejecutivo");
        } else {
