 ...
 * @author Andres
 */
public class BusEjecutivoCentesimo implements Kilometraje {
    ...
    public void categoriaTiquet(double kilometro) {
        if (kilometro < 10 && kilometro >= 1) {

           salario=SalarioMinimo.getInstancia();
            System.out.println("Su pasaje tiene un costo de "+(salario.getValor()/100)+" pesos, su viaje se realizará en Bus ejecutivo");
        } else {
