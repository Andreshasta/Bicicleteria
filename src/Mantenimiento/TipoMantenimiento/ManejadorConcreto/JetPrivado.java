 ...
 * @author Andres
 */
public class JetPrivado implements Kilometraje {
    ...
    public void categoriaTiquet(double kilometro) {
      if ( kilometro >= 1500) {
            ...
            System.out.println("Su pasaje tiene un costo de "+(salario.getValor()*8)+" pesos, su viaje se realizará en Jet Privado");
        } else {
